...
while True:
    iterations += 1
    balesAccessableBefore = balesAccessable
        ...
        for col in range(width):
            if grid[row][col] == "@":
                ...
                if accessable:
                    ...
                    grid[row][col] = "."
    print(
        f"Removed {balesAccessable-balesAccessableBefore} bales in iteration {iterations}")

    if balesAccessableBefore == balesAccessable:
        break
